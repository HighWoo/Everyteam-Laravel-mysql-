...
팀 모집글 출력페이지 작성 엔터를 입력하지 않으면 내용이 쭉 나와버리는 오류발견 [수정완료](###줄바꿈 에러해결)
...
![image](https://user-images.githubusercontent.com/75231868/125891263-b5045e02-726a-4945-9071-b1790438483a.png)
